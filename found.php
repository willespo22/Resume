...
<body style="background-color: #DBDBDB;">
 ...
 <ul>
  ...
  <li><a href="limbo_login.php">Admins</a></li>
    ...
    <div id = "message">
    <div id = "messageT1" style="font-weight:bold"> Found Something? </div>
    <div id = "messageT2"> If you found something, here is where you report it. </div>
...
function show_form($datelost,$location,$item, $desc, $contact, $status) {
  echo '<form action="found.php" method="POST" style="font-family: Trebuchet MS;">' ;
    
  echo '<p><b>Date/Time Found: </b><br><em>Enter the date & time the item was found. If you are not using Google Chrome, enter it in the format: YYYY-MM-DDTHH:MM</em><br><input type="datetime-local" name="datelost" value="' . $datelost . '"> </p> ' ;
    
  echo '<p><b>Location: </b><br><em>Enter the location the item was found.</em><br><input type="text" name="location" value="' . $location . '"></p>' ;
  ...
  #submits every form from this page as a "found" status
  echo '<p><input type="text" name="status" value="found" hidden> </p> ' ;  
